...
| `ftx-supply-uni` | FTX | `192.168.77.20` | `http://192.168.86.240:8020/` | `e08cfe8c1d18` | supply UNI sensors |
...
Supply UNI physical Shelly id `e08cfe8c1d18` verified live during P0016 from `Shelly.GetDeviceInfo` as `shellyplusuni-e08cfe8c1d18`.
