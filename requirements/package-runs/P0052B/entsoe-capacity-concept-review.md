# P0052B ENTSO-E capacity concept review
...
```json
{
  ...
  "contract_types": {
    "A02": {
      "capacity_horizon": "weekly",
      "directional": true,
      "meaning": "Weekly",
      "use_for_utilization": false
    },
    "A03": {
      "capacity_horizon": "monthly",
      "directional": true,
      "meaning": "Monthly",
      "use_for_utilization": false
    },
    "A04": {
      "capacity_horizon": "yearly",
      "directional": true,
      "meaning": "Yearly",
      "use_for_utilization": false
    }
  ...
  "selected_capacity_contract_type": null,
  "status": "capacity_concept_uncertain",
