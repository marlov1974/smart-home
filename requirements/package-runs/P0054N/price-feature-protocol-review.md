...
```json
{
  ...
  "origin_cadence_review": {
    "p0054l2_holdout_contract": {
  ...
  "selected": "p0054n_exact_origin_blocked_train_plus_trainfit_holdout"
}
```
