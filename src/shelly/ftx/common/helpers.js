...
function sget(o, a, d) { if (o && typeof o[a] === "number") return o[a]; return d; }
function on(o) { return o && o.on ? 1 : 0; }
function pct(o) { return sget(o, "pct", 0); }
function w(o) { return sget(o, "w", 0); }
...
function enumSet(id, value, cb) {
  Shelly.call("Enum.Set", { id: id, value: value }, function () { if (cb) cb(); });
}

function numberSet(id, value, cb) {
  Shelly.call("Number.Set", { id: id, value: value }, function () { if (cb) cb(); });
}
